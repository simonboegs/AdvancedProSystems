...
const ContactPage = () => {
  return (
    <Layout>
      <Hero height="200px" img={heroImg} title="Contact Us" body="" marginBottom="20px" />
      <br />
      <ContactForm />
    </Layout>
    ...
    //     <NavBar />
    //   </div>
    //   <Hero height="200px" img={heroImg} title="Contact" body="" marginBottom={padding} />
    //   <div className="container-sm">
    ...
    //         placeholder="Something else - please tell us about your needs!"
    //       />
    //     </div>
    //     <br />
    ...
    //     </div>
    //     <div>
    //       <label for="chooseCountry" class="form-label">
    //         Choose country
    //       </label>
